...
type ComponentProps = {
  document: IDocument;
  control: Control<IAddDocumentProps>;
  setValue: UseFormSetValue<IAddDocumentProps>;
};

export const AddDocument = ({ control, setValue }: ComponentProps) => {
